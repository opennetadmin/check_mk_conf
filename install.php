...
$plugin_name = 'check_mk_conf';

// Set a title
$window['title'] = "Check MK Install";
...
//
$pmodules = array();
$pmodules['check_mk_conf']['desc'] = 'Build check_mk/OMD configurations from ONA';
$pmodules['check_mk_conf']['file'] = "..{$plugindir}/{$plugin_name}.inc.php";
